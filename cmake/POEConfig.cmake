...
if(POE_FOUND)
  ...
  set(MPIEXEC_EXECUTABLE ${POE_EXECUTABLE})
  set(MPIEXEC_EXECUTABLE "-procs")
  ...
  macro(ADD_MPI_TEST TEST_NAME EXEC_NAME PROCS ARGS)
    ...
    string(REGEX REPLACE "mpiexec" "mpirun" MPIEXEC ${MPIEXEC_EXECUTABLE})
    add_test(
      NAME ${TEST_NAME}
      COMMAND
        ${MPIEXEC_EXECUTABLE} ${MPIEXEC_PREFLAGS} ${MPIEXEC_NUMPROC_FLAG}
        ${PROCS} ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${EXEC_NAME}
