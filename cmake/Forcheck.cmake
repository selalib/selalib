...
# add_forcheck_target()
# 
# After generating the makefiles one can use
# make forcheck
#
...
# 
# To run forcheck for all library individually with a single command use
# make forcheck_separate
...
IF(FORCHECK_FOUND)
   ...
   set(FORCHECK_EXTERNAL_FLBS $ENV{FCKDIR}/share/forcheck/MPI_3.flb ${FORCHECK_INPUT_DIR}/hdf5-1_8_18.flb)
...
# Adds custom targets for running the Forcheck analysis
...
function(add_forcheck_target_separate)
  ...
  foreach(_name ${_target_list})
    ...
    if (_sources)
      ...
      # The COMMAND option will need a space separated list while the
      # DEPNDS option nedds a comma separated list
      ...
      add_custom_command(OUTPUT ${FORCHECK_OUTPUT_DIR}/${_name}.flb
        COMMAND forchk -allc -batch -rep ${_name}.rep -l ${_name}.lst ${_fck_incflags} ${_current_library_sources} -update ${_name}.flb ${_flb_space} ${FORCHECK_EXTERNAL_FLBS} || true
