...
contains
 ...
 subroutine compute_current(this)
   ...
   this%jx=this%jx-sum(this%jx(1:this%geomx%nx-1,1:this%geomx%ny-1))/(this%geomx%nx*this%geomx%dx*this%geomx%ny*this%geomx%dy)
   this%jy=this%jy-sum(this%jy(1:this%geomx%nx-1,1:this%geomx%ny-1))/(this%geomx%nx*this%geomx%dx*this%geomx%ny*this%geomx%dy)
