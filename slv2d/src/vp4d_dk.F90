...
call initglobal_dk(geomx,geomv,dt,nbiter,fdiag,fthdiag)
...
call initlocal_dk(geomx,geomv,jstartv,jendv,jstartx,jendx, &
...
contains
 ...
 subroutine initglobal_dk(geomx,geomv,dt,nbiter,fdiag,fthdiag)
  ...
  sll_real64      :: a,rhomin,rhomax,aspect_ratio,vmax,dt
  
  sll_int32 :: my_num, num_threads, comm
  namelist /MESH/ Nr,Ntheta,Nphi,Nvpar,a,rhomin,rhomax,aspect_ratio,vmax,nbiter,dt,&
           &fdiag,fthdiag    
!  &MESH
!  Nr           = 127
!  Ntheta       = 128
...
!  fthdiag      = 30
  ...
  call new(geomx,a*rhomin,0._f64,a*rhomax,2._f64*sll_pi,Nr,Ntheta,iflag,"pery")  
  call new(geomv,0._f64,-vmax,2._f64*sll_pi,vmax,Nphi,Nvpar,iflag,"perxy")
  !call new(geomv,0._f64,-vmax,2._f64*sll_pi,vmax,nvx,nvy,iflag,"perx")

 end subroutine initglobal_dk



 subroutine initlocal_dk(geomx,geomv,jstartv,jendv,jstartx,jendx, &
  ...
  sll_int32  :: i,j,iv,jv,iflag,ierr
  sll_int32  :: my_num, num_threads, comm


  !EQUIL
  sll_int32       :: m,n,init_perturb
  logical         :: zonal_flow
  ...
  namelist /EQUIL/ rpeak,kappan,kappaTi,kappaTe,deltarn,deltarTi,deltarTe,&
           &epsilon,m,n,init_perturb,zonal_flow
...
!  zonal_flow     = .true.
  ...
  call mpi_bcast(m,   1,MPI_INTEGER ,MPI_MASTER,comm,ierr)
  call mpi_bcast(n,   1,MPI_INTEGER ,MPI_MASTER,comm,ierr)
  call mpi_bcast(init_perturb,   1,MPI_INTEGER ,MPI_MASTER,comm,ierr)
