...
contains
  ...
  function landau_1d(eps,kx, x, v2)
    ...
    landau_1d = (1._f64+eps*cos(kx*x))/(2*sll_p_pi)*exp(-0.5_f64*v2)
  ...
  function landau_cos_sum(eps,kx, ky, x, y, v2)
    ...
    landau_cos_sum = (1._f64+eps*cos(kx*(x+y)))/(2*sll_p_pi)*exp(-0.5_f64*v2)
  ...
  function tsi(eps, kx, x, vx, v2)
    ...
    tsi = (1._f64+eps*cos(kx*x))/(2*sll_p_pi)*exp(-0.5_f64*v2)*vx*vx
