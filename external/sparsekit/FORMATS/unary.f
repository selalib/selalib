...
c
c diag  = real( kind = 8 ) array of length nrow containing the wanted diagonal.
...
c dd	= real( kind = 8 ) array of length n. On output,entry dd(i) contains
...
c on return:
c----------
c bdiag = real( kind = 8 ) array of size (n x nblk) containing the diagonal
