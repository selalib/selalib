...
c nrow   = number of rows in matrix
c ncol	 = number of columns in matrix 
c a	 = real( kind = 8 ) array containing the values of the matrix stored 
c          columnwise
...
c-----------
         write(valfmt,ix) nperli,len,ifmt
c105     format(1h(,i1,1hD,i1,1h.,i1,1h) )
c106     format(1h(,i1,1hD,i2,1h.,i1,1h) )
c107     format(1h(,i1,1hD,i2,1h.,i2,1h) )
c108     format(1h(,i2,1hD,i1,1h.,i1,1h) )
c109     format(1h(,i2,1hD,i2,1h.,i1,1h) )
c110     format(1h(,i2,1hD,i2,1h.,i2,1h) )
c     
      endif              
