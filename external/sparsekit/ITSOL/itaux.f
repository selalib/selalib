     ...
     +     au,jau,ju,solver)
      ...
      real( kind = 8 ) fpar(16),rhs(n),sol(n),guess(n),wk(*),a(*),au(*)
      external solver
c-----------------------------------------------------------------------
...
c
      ...
      function hfun (x,y,z)
      real( kind = 8 ) hfun, x,y, z, gammax, gammay, alpha
      common /func/ gammax, gammay, alpha
