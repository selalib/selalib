...
c
      ...
      real( kind = 8 ) wk(lw),rhs(nmax),a(nzmax),alu(nzumax)
      integer jw(nt2), iperm(nt2) 
      real( kind = 8 ) w(nt2),sol(nt2) 
      integer n, mbloc 
...
c     up to 10 matrices 
c
      real( kind = 8 ) droptol, dropinc, t, permtol, tol, eps, rand, alph, dnrm2 
c
c-----------------------------------------------------------------------
      data iin/4/, iout/8/ 
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
      ...
      implicit none
      integer n, jlu(*),ju(*) 
      real( kind = 8 ) sol(n),alu(*),tmax
c----------------------------------------------------------------------- 
      real( kind = 8 ) max, t, abs
      integer j
c
