...
c-----------------------------------------------------------------------
      implicit none 
      integer n
      real( kind = 8 ) a(*),alu(*),w(2*n),tol, alph 
...
c-----------------------------------------------------------------------
     ...
     *     iperm(2*n),ierr
      real( kind = 8 ) a(*), alu(*), w(2*n), alph, droptol, permtol 
c----------------------------------------------------------------------*
...
c           lfil must be .ge. 0 
c
c tol     = real( kind = 8 ). Sets the threshold for dropping small terms in the
c           factorization. See below for details on dropping strategy.
c  
...
c-----------------------------------------------------------------------
       ...
       real( kind = 8 ) vv(n,*), rhs(n), sol(n), aa(*), alu(*), eps
c----------------------------------------------------------------------*
c                                                                      *
...
c----------------------------------------------------------------------*
       parameter (kmax=50)
       real( kind = 8 ) hh(kmax+1,kmax), c(kmax), s(kmax), rs(kmax+1),t
c-------------------------------------------------------------
