...
c
c ... purpose (see muh24cr.d for details)
c
...
c
c     see the documentation file "muh24cr.d" for a complete discussion
c     of how to use subroutine muh24cr.  file "tmuh24cr.f" is a test/driver
c     sample program illustrating use of muh24cr
c
