...
c
c     see the documentation file "cuh34.d" for a complete discussion
c     of how to use subroutine cuh34.  file "tcuh34.f" is a test/driver
c     sample program illustrating use of cuh34
c
c ... purpose (see cuh34.d for details)
c
