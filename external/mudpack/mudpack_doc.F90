...
! selalib/doc/build/html/doxygen/html/defgroup mudpacks.html
...
!> @details
!> Long description of  mudpack, you can add some references or math equations.
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_mudpack.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_mudpack </code>
!>
!> <b> Examples </b>
