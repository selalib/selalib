...
c
c ... purpose (see cud3sp.d for details)
c
...
c
c     see the documentation file "cud3sp.d" for a complete discussion
c     of how to use subroutine cud3sp.  file "tcud3sp.f" is a test/driver
c     sample program illustrating use of cud3sp
c
