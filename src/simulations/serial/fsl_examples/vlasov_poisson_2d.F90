...
integer(4),parameter ::  ntau =64,Nn=128!, Mn=514
...
!real(8)    ::f,tmpp, tmpm,nd,ff2,tmp
complex(8) :: sumup1,sumup2,dtgn
real(8)    :: tau(0:ntau-1), ltau(0:ntau-1),lx(1:Nn),Etemp(1:Nn),w1_0(0:ntau-1),w2_0(0:ntau-1),fvr(1:Nn,1:Nn)!,ltaus(0:mn-1)
complex(8) :: F1(0:ntau-1),F2(0:ntau-1),Ftilde1(0:ntau-1),Ftilde2(0:ntau-1)
!complex(8) :: erftilde(0:mn-1),erf(1:Mn),tmp1(1:mn+1),tmp2(1:mn+1)
...
real(8), intent(in)      :: fh_fsl(1:Nn,1:Nn),t,r(1:Nn),v(1:Nn),lx(1:Nn)
real(8), intent(inout)   :: fvr(1:Nn,1:Nn)
complex(8) :: ftilde(1:Nn,1:Nn), f(1:Nn)
complex(8),   allocatable :: ftemp(:,:)
complex(8),   allocatable :: ftemp_1d(:)
type(C_PTR) :: PlnF2
real(8)    :: x,y,x_array(Nn),y_array(Nn),L,epsnufft
...
real(8) :: x,L
integer(4) :: n
complex(8) :: Etilde1(1:Nn),Etilde2(1:Nn),sum0, E0(1:Nn)
L=4.0d0
