...
!    if(iter==400)then    
!        call sll_gnuplot_2d(0.1_f64,14.5_f64,nc_x1+1,0._f64,2._f64*sll_pi,nc_x2+1,sim%f4d_seqx1x2x4(:,:,1,nc_x4/2),'fdist',800,ierr)
!    endif
!    if(iter==1000)then    
!        call sll_gnuplot_2d(0.1_f64,14.5_f64,nc_x1+1,0._f64,2._f64*sll_pi,nc_x2+1,sim%f4d_seqx1x2x4(:,:,1,nc_x4/2),'fdist',2000,ierr)
!    endif
!    if(iter==1500)then    
!        call sll_gnuplot_2d(0.1_f64,14.5_f64,nc_x1+1,0._f64,2._f64*sll_pi,nc_x2+1,sim%f4d_seqx1x2x4(:,:,1,nc_x4/2),'fdist',3000,ierr)
!    endif
!    if(iter==2000)then    
!        call sll_gnuplot_2d(0.1_f64,14.5_f64,nc_x1+1,0._f64,2._f64*sll_pi,nc_x2+1,sim%f4d_seqx1x2x4(:,:,1,nc_x4/2),'fdist',4000,ierr)
!    endif
!    if(iter==2500)then    
!        call sll_gnuplot_2d(0.1_f64,14.5_f64,nc_x1+1,0._f64,2._f64*sll_pi,nc_x2+1,sim%f4d_seqx1x2x4(:,:,1,nc_x4/2),'fdist',5000,ierr)
!    endif
!    if(iter==3000)then    
!        call sll_gnuplot_2d(0.1_f64,14.5_f64,nc_x1+1,0._f64,2._f64*sll_pi,nc_x2+1,sim%f4d_seqx1x2x4(:,:,1,nc_x4/2),'fdist',6000,ierr)
!    endif
!    if(iter==3500)then    
!        call sll_gnuplot_2d(0.1_f64,14.5_f64,nc_x1+1,0._f64,2._f64*sll_pi,nc_x2+1,sim%f4d_seqx1x2x4(:,:,1,nc_x4/2),'fdist',7000,ierr)
!    endif
