...
#include "sll_utilities.h"
  ...
  use sll_m_parallel_array_initializer  ! Needed to initialize 2D fields
...
contains
  ...
  subroutine run_2d_gc_general(sim)
   ...
   rho_n_ptr => new_scalar_field_2d_discrete( &
         "rho_n", &
         sim%interp_rho, &     
         sim%transf, &
         sim%bc_left, &
   ...
   call rho_n_ptr%update_interpolation_coefficients( )
    ...
    rho_np1_ptr => new_scalar_field_2d_discrete( &
         "rho_np1", &
         sim%interp_rho, &     
         sim%transf, &
         sim%bc_left, &
   ...
   rho_nm1_ptr => new_scalar_field_2d_discrete( &
         "rho_nm1", &
         sim%interp_rho, &     
         sim%transf, &
         sim%bc_left, &
