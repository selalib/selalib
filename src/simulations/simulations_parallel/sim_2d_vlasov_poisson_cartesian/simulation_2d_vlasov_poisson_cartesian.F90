...
subroutine init_vp2d_par_cart( sim, filename, num_run )
 ...
 !! set default parameters (module global variables)
...
>>>>>>> origin/prototype-devel
 ...
 case ("SLL_AMPERE_DRIVE")
    ...
    sim%turn_drive_off = .false.
    sim%Edrmax         = 0.
    sim%omegadr        = 1.   ! time normalised to inverse plasma frequency        
...
subroutine run_vp2d_cartesian(sim)
 ...
 ! initialise f_x1_equil that is used to define deltaf: 
 ! deltaf =  f_x1 - f_x1_equil
 call sll_2d_parallel_array_initializer_cartesian( &
      layout_x1,                                     &
      sim%x1_array,                                  &
      node_positions_x2,                             &
