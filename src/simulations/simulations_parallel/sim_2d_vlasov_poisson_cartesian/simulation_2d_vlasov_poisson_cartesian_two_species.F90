...
module sll_simulation_2d_vlasov_poisson_cartesian_two_species
...
contains
  ...
  function new_vp2d_par_cart_two_species( filename, num_run ) result(sim)    
    ...
    call init_vp2d_par_cart_two_species( sim, filename, num_run )
       
  end function new_vp2d_par_cart_two_species

  subroutine change_initial_function_vp2d_par_cart_two_species( sim,       &
                                                    init_func, &
                                                    params,    &
                                                    num_params)
  ...
  subroutine change_equilibrium_function_vp2d_par_cart_two_species( sim,        &
                                                        equil_func, &
                                                        params,     &
                                                        num_params)
  ...
  end subroutine change_equilibrium_function_vp2d_par_cart_two_species
