...
SLL_ALLOCATE(rho_mode(0:sim%nb_mode),ierr) ; rho_mode = (0.0_f64,0.0_f64)
SLL_ALLOCATE(f_hat_x2(1:sim%nb_mode+1),ierr); f_hat_x2 = 0.0_f64
SLL_ALLOCATE(f_hat_x2_loc(1:sim%nb_mode+1),ierr); f_hat_x2_loc = 0.0_f64
