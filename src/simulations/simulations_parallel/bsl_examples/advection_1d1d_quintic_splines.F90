...
!###########################################################
  ...
  call spl_eta1%initialize(nc_eta1+1,eta1_min,eta1_max,SLL_PERIODIC,SLL_PERIODIC)

  call spl_eta2%initialize(nc_eta2+1,eta2_min,eta2_max,SLL_PERIODIC,SLL_PERIODIC)
