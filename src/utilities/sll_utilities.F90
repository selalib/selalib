...
!>  
!------------------------------------------------------------------------
subroutine errout( out_unit, severity, file_name, line_num, message )
                   

  sll_int32       , intent(in) :: out_unit  !< output file unit number
  character(len=1), intent(in) :: severity  !< "W" or "F" : Warning or Fatal
  character(len=*), intent(in) :: file_name !< file name
  sll_int32       , intent(in) :: line_num  !< line number 
  character(len=*), intent(in) :: message   !< error message

  character(len=6) :: line_num_str
  ...
  call int2string( line_num, line_num_str )

!  write( out_unit,"(/10x,a)") &
!    'Generated by program or subroutine: ', trim( func_name )
  write( out_unit,"(/10x,a)") &
    trim( file_name )//':'// trim( line_num_str )//':'
...
!     error stop 'Fatal Error: See print file for details'
     call abort()
  end if
