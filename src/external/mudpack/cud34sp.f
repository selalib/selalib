...
c
c     see the documentation file "cud34sp.d" for a complete discussion
c     of how to use subroutine cud34sp.  file "tcud34sp.f" is a test/driver
c     sample program illustrating use of cud34sp
c
c ... purpose (see cud34sp.d for details)
c
