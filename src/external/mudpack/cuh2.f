...
c
c ... purpose (see cuh2.d for details)
c
...
c
c     see the documentation file "cuh2.d" for a complete discussion
c     of how to use subroutine cuh2.  file "tcuh2.f" is a test/driver
