...
c
c ... purpose (see cuh3.d for details)
c
...
c
c     see the documentation file "cuh3.d" for a complete discussion
c     of how to use subroutine cuh3.  file "tcuh3.f" is a test/driver
c     sample program illustrating use of cuh3
c
