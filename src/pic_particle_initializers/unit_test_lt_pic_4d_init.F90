program lt_pic_4d_init_tester
!program lt_pic_init4D_tester       ! old name
...
#define DOMAIN_IS_X_PERIODIC .false.
#define DOMAIN_IS_Y_PERIODIC .false. 
...
end program lt_pic_4d_init_tester
