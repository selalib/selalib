...
c
c ... purpose (see cud2cr.d for details)
c
...
c
c     see the documentation file "cud2cr.d" for a complete discussion
c     of how to use subroutine cud2cr.  file "tcud2cr.f" is a test/driver
c     sample program illustrating use of cud2cr
c
