...
c
c ... purpose (see muh24.d for details)
c
...
c
c     see the documentation file "muh24.d" for a complete discussion
c     of how to use subroutine muh24.  file "tmuh24.f" is a test/driver
