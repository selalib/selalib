...
c
c ... purpose (see cud24.d for details)
c
...
c
c     see the documentation file "cud24.d" for a complete discussion
c     of how to use subroutine cud24.  file "tcud24.f" is a test/driver
c     sample program illustrating use of cud24
c
