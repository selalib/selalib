...
c
c ... purpose (see mud24cr.d for details)
c
...
c
c     see the documentation file "mud24cr.d" for a complete discussion
c     of how to use subroutine mud24cr.  file "tmud24cr.f" is a test/driver
c     sample program illustrating use of mud24cr
c
