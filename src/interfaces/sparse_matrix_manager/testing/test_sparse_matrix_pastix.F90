program test_sparse_matrix_pastix
...
print *,'#begin sll_f_new_csr_matrix with pastix solver'
...
print *,'#end sll_f_new_csr_matrix with pastix solver'
...
print *,'#end sll_s_solve_csr_matrix with pastix'
...
end program test_sparse_matrix_pastix
