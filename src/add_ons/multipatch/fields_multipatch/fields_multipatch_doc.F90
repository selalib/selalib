...
! selalib/doc/build/html/doxygen/html/defgroup fields_multipatchs.html 
...
!> @details
!> Long description of  fields_multipatch, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_fields_multipatch.h
!>
!> <b> Modules available </b>
!>  List fortran module available
!>  - sll_fields_multipatch
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_fields_multipatch.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_fields_multipatch </code>
!>
!> <b> Examples </b>
