...
dnl
dnl
DESCRIPTOR_HEADER(vlasovpoisson_sim,(SLL_LANDAU_DIAG,SLL_LANDAU_SUM,SLL_LANDAU_PROD))
DESCRIPTOR_HEADER(boundary,(OPEN,CLOSED))

contains

DESCRIPTOR_BODY(vlasovpoisson_sim,(SLL_LANDAU_DIAG,SLL_LANDAU_SUM,SLL_LANDAU_PROD))
