...
!!$  integer, parameter                       :: nn = 4   ! change
  ...
  ! Remap stuff
  type(sll_t_layout_5d), pointer                  :: layout1
  type(sll_t_layout_5d), pointer                  :: layout2
  type(sll_t_remap_plan_5d_real64), pointer       :: rmp5
  ...
  do, i_test=1, nbtest
     ...
     layout1  => sll_f_new_layout_5d( sll_v_world_collective )        
              ...
              do k=1,loc_sz_k_init
                 do j=1,loc_sz_j_init 
                    do i=1,loc_sz_i_init
                       ...
                       local_array1(i,j,k,l,m) = real(lin_index,f64)
...
!!$     end if
     ...
     layout2  => sll_f_new_layout_5d( sll_v_world_collective )
     call factorize_in_random_2powers_5d(colsz, npi, npj, npk, npl, npm)
!!$     npi = 4
!!$     npj = 2
!!$     npk = 1
!!$     npl = 1
     ...
     rmp5 => sll_o_new_remap_plan( layout1, layout2, local_array1 )     
...
!!$     end if
     ...
     call sll_o_apply_remap_5d( rmp5, local_array1, local_array2 ) 
