...
!> \code call sll_s_boot_collective() \endcode
!> and to "turn off" the parallel capabilities, one should finish by a call to:
!> \code call sll_s_halt_collective() \endcode
...
!> </tr>
!> <tr>
!> <td>sll_v_world_collective</td>
!> <td>MPI_COMM_WORLD</td>
!> </tr>
!> <tr>
!> <td>sll_s_boot_collective()</td>
!> <td>MPI_INIT(integer :: code)</td>
!> </tr>
!> <tr>
!> <td>sll_s_halt_collective()</td>
!> <td>MPI_FINALIZE(integer :: code)</td>
!> </tr>
!> <tr>
!> <td>sll_f_get_collective_rank(type(sll_t_collective_t), pointer :: col )</td>
!> <td>MPI_COMM_RANK(integer :: comm , integer :: rank , integer :: code)</td>
!> </tr>
!> <tr>
!> <td>sll_f_get_collective_size(type(sll_t_collective_t), pointer :: col )</td>
!> <td>MPI_COMM_SIZE(integer :: comm , integer :: size , integer :: code)</td>
!> </tr>
!> <tr>
!> <td>sll_get_collective_color(type(sll_t_collective_t), pointer :: col )</td>
!> <td></td>
!> </tr>
!> <tr>
!> <td>sll_get_collective_comm(type(sll_t_collective_t), pointer :: col )</td>
!> <td></td>
!> </tr>
!> <tr>
!> <td>sll_s_collective_barrier(type(sll_t_collective_t), pointer :: col )</td>
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  type sll_t_collective_t
     type(sll_t_collective_t), pointer :: parent=>null() !< Pointer to parent communicator
...
contains !************************** Operations **************************
  ...
  !> @param[in] ptr pointer to \a sll_t_collective_t type
