...
!
module sll_m_vector_space_real_array_2d
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#include "sll_errors.h"
   ...
   public :: sll_t_vector_space_real_array_2d
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   !>          2D Fortran real array
   type, extends(sll_c_vector_space) :: sll_t_vector_space_real_array_2d
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   subroutine copy__real(self, x)
      class(sll_t_vector_space_real_array_2d), intent(inout) :: self
      class(sll_c_vector_space), intent(in) :: x

      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_2d % copy"

      select type (x)

      class is (sll_t_vector_space_real_array_2d)
   ...
   subroutine incr__real(self, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_2d % incr"
   ...
   subroutine add__real(self, x, y)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_2d % add"
   ...
   subroutine mult__real(self, a, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_2d % mult"
   ...
   subroutine mult_add__real(self, a, x, y)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_2d % mult_add"
   ...
   subroutine incr_mult__real(self, a, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_2d % incr_mult"
   ...
   subroutine lcmb__real(self, a, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_2d % lcmb"
   ...
   subroutine incr_lcmb__real(self, a, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_2d % incr_lcmb"
   ...
   function norm__real(self) result(res)
      class(sll_t_vector_space_real_array_2d), intent(in) :: self
      real(wp) :: res
   ...
   function inner__real(self, x) result(res)
      ...
      character(len=*), parameter :: this_fun_name = "sll_t_vector_space_real_array_2d % inner"
...
end module sll_m_vector_space_real_array_2d
