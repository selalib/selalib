...
!> @brief   Vector space for wrapping 1D Fortran real arrays
!
module sll_m_vector_space_real_array_1d
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#include "sll_errors.h"
   ...
   public :: sll_t_vector_space_real_array_1d
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   !>          1D Fortran real array
   type, extends(sll_c_vector_space) :: sll_t_vector_space_real_array_1d
   ...
   end type sll_t_vector_space_real_array_1d
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   subroutine copy__real(self, x)
      class(sll_t_vector_space_real_array_1d), intent(inout) :: self
      class(sll_c_vector_space), intent(in) :: x

      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_1d % copy"
   ...
   subroutine incr__real(self, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_1d % incr"
   ...
   subroutine add__real(self, x, y)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_1d % add"
   ...
   subroutine mult__real(self, a, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_1d % mult"
   ...
   subroutine mult_add__real(self, a, x, y)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_1d % mult_add"
   ...
   subroutine incr_mult__real(self, a, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_1d % incr_mult"
   ...
   subroutine lcmb__real(self, a, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_1d % lcmb"
   ...
   subroutine incr_lcmb__real(self, a, x)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_vector_space_real_array_1d % incr_lcmb"
   ...
   function norm__real(self) result(res)
      class(sll_t_vector_space_real_array_1d), intent(in) :: self
      real(wp) :: res

#ifdef __PGI
      res = sqrt(dot_product(self%array, self%array))
#else
   ...
   function inner__real(self, x) result(res)
      ...
      character(len=*), parameter :: this_fun_name = "sll_t_vector_space_real_array_1d % inner"

      select type (x)

      class is (sll_t_vector_space_real_array_1d)

         res = dot_product(self%array, x%array)
...
end module sll_m_vector_space_real_array_1d
