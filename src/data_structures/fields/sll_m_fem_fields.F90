...
contains
   ...
   procedure, pass :: write_to_file => write_fem_field_2d_to_file
   procedure, pass :: set_value => initialize_fem_field_2d 

end type sll_fem_field_2d
...
interface sll_new
  module procedure new_fem_field_2d
end interface sll_new

!> sum operator DG field 2d
interface operator(+)
  module procedure fem_field_add
end interface operator(+)

!> sub operator DG field 2d
interface operator(-)
  module procedure fem_field_sub
end interface operator(-)
...
function new_fem_field_2d( degree, tau, init_function ) result (this) 
   ...
   sll_int32                      :: nc_eta1
   sll_int32                      :: nc_eta2
   type(sll_fem_field_2d), pointer :: this
   sll_int32                      :: error
   ...
   if (present(init_function)) then
      call initialize_fem_field_2d( this, init_function, 0.0_f64) 
   end if

   this%tag = 0
   this%file_id = 0

end function new_fem_field_2d

subroutine initialize_fem_field_2d( this, init_function, time) 

   class(sll_fem_field_2d)      :: this
...
end subroutine initialize_fem_field_2d

subroutine write_fem_field_2d_to_file( this, field_name, file_format, time )
   ...
   if (present(file_format)) then
      ...
      case(SLL_IO_GMSH)
      call plot_fem_field_2d_with_gmsh(this, field_name)
      case(SLL_IO_MTV)
      call plot_fem_field_2d_with_plotmtv(this, field_name)
      case(SLL_IO_XDMF)
      if (present(time)) then
         call plot_fem_field_2d_with_xdmf(this, field_name, time)
      else
         call plot_fem_field_2d_with_xdmf(this, field_name)
      end if
      case default
         print"(a)", field_name//' write_to_file : Unknown format'
      end select
   else
      call plot_fem_field_2d_with_gnuplot( this, field_name )
   endif

end subroutine write_fem_field_2d_to_file

subroutine plot_fem_field_2d_with_gnuplot( this, field_name )
...
end subroutine plot_fem_field_2d_with_gnuplot

function fem_field_add( W1, W2) result(W3)

  type(sll_fem_field_2d), intent(in) :: W1
  type(sll_fem_field_2d), intent(in) :: W2
  type(sll_fem_field_2d)             :: W3
...
end function fem_field_add

function fem_field_sub( W1, W2) result(W3)
...
end function fem_field_sub

subroutine plot_fem_field_2d_with_gmsh(this, field_name)
...
end subroutine plot_fem_field_2d_with_gmsh

subroutine plot_fem_field_2d_with_plotmtv(this, field_name)
...
end subroutine plot_fem_field_2d_with_plotmtv

subroutine plot_fem_field_2d_with_xdmf(this, field_name, time)
...
end subroutine plot_fem_field_2d_with_xdmf

end module sll_m_fem_fields
