...
#include "sll_errors.h"
   ...
   use sll_m_linear_operator_matrix_dense_to_stencil_new, only: sll_t_linear_operator_matrix_dense_to_stencil_new

   use sll_m_linear_operator_matrix_stencil_to_dense_new, only: sll_t_linear_operator_matrix_stencil_to_dense_new
   ...
   public :: sll_t_linear_operator_matrix_c1_block_new
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   type, extends(sll_c_linear_operator) :: sll_t_linear_operator_matrix_c1_block_new
      ...
      type(sll_t_linear_operator_matrix_stencil_to_dense_new) :: block2
      type(sll_t_linear_operator_matrix_dense_to_stencil_new) :: block3
      type(sll_t_linear_operator_matrix_stencil_to_stencil) :: block4

   contains

      procedure :: init => s_linear_operator_matrix_c1_block_new__init
      procedure :: get_shape => f_linear_operator_matrix_c1_block_new__get_shape
      procedure :: dot => s_linear_operator_matrix_c1_block_new__dot
      procedure :: dot_incr => s_linear_operator_matrix_c1_block_new__dot_incr
      procedure :: to_array => s_linear_operator_matrix_c1_block_new__to_array
      procedure :: free => s_linear_operator_matrix_c1_block_new__free

   end type sll_t_linear_operator_matrix_c1_block_new
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   function f_linear_operator_matrix_c1_block_new__get_shape(self) result(s)
      class(sll_t_linear_operator_matrix_c1_block_new), intent(in) :: self
      integer :: s(2)

      s = self%block1%get_shape() + self%block2%get_shape() + &
          self%block3%get_shape() + self%block4%get_shape()

   end function f_linear_operator_matrix_c1_block_new__get_shape
   ...
   end subroutine s_linear_operator_matrix_c1_block_new__dot
   ...
   subroutine s_linear_operator_matrix_c1_block_new__dot_incr(self, x, y)
      ...
      character(len=*), parameter :: this_sub_name = "sll_t_linear_operator_matrix_c1_block_new_new % dot_incr"
      character(len=64) :: err_msg
   ...
   end subroutine s_linear_operator_matrix_c1_block_new__dot_incr
   ...
   end subroutine s_linear_operator_matrix_c1_block_new__to_array
   ...
   end subroutine s_linear_operator_matrix_c1_block_new__free

end module sll_m_linear_operator_matrix_c1_block_new
