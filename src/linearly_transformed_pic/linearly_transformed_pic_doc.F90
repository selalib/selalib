...
! selalib/doc/build/html/doxygen/html/defgroup linearly_transformed_pics.html 
...
!> @details
!> Long description of  linearly_transformed_pic, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_linearly_transformed_pic.h
!>
!> <b> Modules available </b>
!>  List fortran module available
!>  - sll_linearly_transformed_pic
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_linearly_transformed_pic.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_linearly_transformed_pic </code>
!>
!> <b> Examples </b>
