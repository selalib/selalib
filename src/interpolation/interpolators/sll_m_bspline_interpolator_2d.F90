...
#include "sll_working_precision.h"
  ...
  type, extends(sll_c_interpolator_2d) :: sll_t_bspline_interpolator_2d
    ...
    type(sll_t_spline_2d_non_uniform), pointer :: spline   !< The spline object to store coefficients
  ...
  contains
    ...
    procedure, pass(interpolator) :: initialize=>sll_s_bspline_interpolator_2d_init
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  end subroutine sll_s_bspline_interpolator_2d_init
  ...
  subroutine compute_interpolants_bs2d( &
    ...
    call sll_s_spline_2d_non_uniform_compute_interpolant( interpolator%spline, data_array )
  ...
  function interpolate_value_bs2d( interpolator, eta1, eta2 ) result(val)
    ...
    val = 0.0_f64
    !val = sll_f_spline_2d_non_uniform_eval( interpolator%spline, eta1, eta2, 0, 0 )
  ...
  function interpolate_deriv1_bs2d( interpolator, eta1, eta2 ) result(val)
    ...
    val = 0.0_f64
    !val = sll_f_spline_2d_non_uniform_eval( interpolator%spline, eta1, eta2, 1, 0 )
  ...
  function interpolate_deriv2_bs2d( interpolator, eta1, eta2 ) result(val)
    ...
    val = 0.0_f64
    !val = sll_f_spline_2d_non_uniform_eval( interpolator%spline, eta1, eta2, 0, 1 )
  ...
  subroutine spline_interpolate2d(this,              &
    ...
    call sll_s_spline_2d_non_uniform_compute_interpolant( this%spline, data_in )
