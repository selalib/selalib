...
call sll_s_bspline_1d_compute_interpolant ( interpolator%bspline, data_array )
...
val = sll_f_bspline_1d_eval( interpolator%bspline, res)
...
val = sll_f_bspline_1d_eval_deriv( interpolator%bspline, res )
