...
#include "sll_working_precision.h"
  ...
  public :: sll_t_linear_operator_MG_cl

  private

  type, extends(sll_t_linear_operator_abstract) :: sll_t_linear_operator_MG_cl
   ...
   contains
     procedure :: create => create_linear_operator_MG_cl
     procedure :: free => free_MG_cl
     procedure :: dot => dot_MG_cl
     procedure :: print_info => print_info_MG_cl

  end type sll_t_linear_operator_MG_cl

contains


  subroutine create_linear_operator_MG_cl( self, mass, n_dofs, delta_x, s_deg_0 )
    class(sll_t_linear_operator_MG_cl), intent( inout ) :: self !< Linear operator object
  ...
  end subroutine create_linear_operator_MG_cl
  ...
  end subroutine free_MG_cl


  subroutine dot_MG_cl( self, x, y )
    class(sll_t_linear_operator_MG_cl), intent( in ) :: self !< Linear operator object
  ...
  end subroutine dot_MG_cl

  subroutine print_info_MG_cl( self )
    class(sll_t_linear_operator_MG_cl), intent(in) :: self !< Linear operator object
  end subroutine print_info_MG_cl


end module sll_m_linear_operator_MG_cl
