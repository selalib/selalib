        ...
        do j1 = 1, p1+1
          do j2 = 1, p2+1
            ...
            call self % weak_form % element( &
              test_values_and_derivs_eta1  = data_1d_eta1(:,:,i1,k1)  , &
              test_values_and_derivs_eta2  = data_1d_eta2(:,:,i2,k2)  , &
              trial_values_and_derivs_eta1 = data_1d_eta1(:,:,j1,k1)  , &
              trial_values_and_derivs_eta2 = data_1d_eta2(:,:,j2,k2)  , &
