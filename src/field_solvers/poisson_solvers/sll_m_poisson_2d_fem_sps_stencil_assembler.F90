module sll_m_poisson_2d_fem_sps_stencil_assembler
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  public :: sll_t_poisson_2d_fem_sps_stencil_assembler
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  type :: sll_t_poisson_2d_fem_sps_stencil_assembler
  ...
  contains
    ...
    procedure :: init            => s_poisson_2d_fem_sps_stencil_assembler__init
    procedure :: add_element_mat => s_poisson_2d_fem_sps_stencil_assembler__add_element_mat
    procedure :: add_element_rhs => s_poisson_2d_fem_sps_stencil_assembler__add_element_rhs

  end type sll_t_poisson_2d_fem_sps_stencil_assembler
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  ! Initializer
  subroutine s_poisson_2d_fem_sps_stencil_assembler__init( self, n1, n2, p1, p2, weak_form )
    class(sll_t_poisson_2d_fem_sps_stencil_assembler) , intent(inout) :: self
  ...
  subroutine s_poisson_2d_fem_sps_stencil_assembler__add_element_mat( &
    self        , &
    k1          , &
    k2          , &
    data_1d_eta1, &
    ...
    A           , &
    M )
    class(sll_t_poisson_2d_fem_sps_stencil_assembler), intent(in   ) :: self
  ...
  end subroutine s_poisson_2d_fem_sps_stencil_assembler__add_element_mat

  ! Add element in stiffness and mass matrices
  subroutine s_poisson_2d_fem_sps_stencil_assembler__add_element_rhs( &
    self        , &
    k1          , &
    k2          , &
    data_1d_eta1, &
  ...
  end subroutine s_poisson_2d_fem_sps_stencil_assembler__add_element_rhs

end module sll_m_poisson_2d_fem_sps_stencil_assembler
