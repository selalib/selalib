module sll_m_elliptic_2d_fem_sps_weak_form
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  public :: sll_c_elliptic_2d_fem_sps_weak_form
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  type, abstract :: sll_c_elliptic_2d_fem_sps_weak_form
  ...
  end type sll_c_elliptic_2d_fem_sps_weak_form
  ...
  abstract interface
    ...
    subroutine i_sub_element_mat( &
      ...
      Aij, &
      Mij )
      import sll_c_elliptic_2d_fem_sps_weak_form, wp
      class(sll_c_elliptic_2d_fem_sps_weak_form), intent(in   ) :: self
...
end module sll_m_elliptic_2d_fem_sps_weak_form
