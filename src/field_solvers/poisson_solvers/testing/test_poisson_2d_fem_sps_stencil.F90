...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  ! Integer variables
  integer :: n1, n2, p1, p2, ncells1, ncells2, ntau1, ntau2, Nk1, Nk2, Nq1, Nq2, &
  ...
  real(wp), allocatable :: gtau(:,:), phi_spl(:,:), err(:,:), quad_points_eta1(:,:), &
...
!  real(wp), allocatable :: Mp(:,:)
  ...
  ! Create HDF5 file
  call sll_s_hdf5_ser_file_create( 'test_poisson_2d_fem_sps_stencil.h5', file_id(1), file_er(1) )
  ...
  call sll_s_hdf5_ser_file_open( 'test_poisson_2d_fem_sps_stencil_rho.h5', file_id(2), file_er(2) )
...
!  call solver % Mp_linop_c1_block % to_array( Mp )
  ...
  call solver % accumulate_charge( spline_2d_rhs )
...
!  call sll_o_hdf5_ser_write_array( file_id(1), A, "/A", file_er(1) )
!
!  ! Write mass matrix
!  call sll_o_hdf5_ser_write_array( file_id(1), M, "/M", file_er(1) )
!
!!  ! Write right hand side
!!  call sll_o_hdf5_ser_write_array( file_id(1), solver % b, "/b", file_er(1) )
!
!  ! Write C1 projection of stiffness matrix
!  call sll_o_hdf5_ser_write_array( file_id(1), Ap, "/Ap", file_er(1) )
!
!  ! Write C1 projection of mass matrix
!  call sll_o_hdf5_ser_write_array( file_id(1), Mp, "/Mp", file_er(1) )
!
!!  ! Write L matrix needed for projection
!!  call sll_o_hdf5_ser_write_array( file_id(1), solver % L, "/L", file_er(1) )
  ...
  deallocate( breaks_eta1, breaks_eta2, tau_eta1, tau_eta2, gtau, phi_spl, err, &
