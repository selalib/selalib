...
contains
  function new_poisson_2d_polar_parallel_solver( &
    ...
    call initialize_poisson_2d_polar_parallel_solver( &
      poisson, &
      layout_r, &
      layout_a, &
      eta1_min, &
  ...
  end subroutine initialize_poisson_2d_polar_parallel_solver
  
  ! solves -\Delta phi = rho in 2d
  subroutine compute_phi_from_rho_2d_polar( poisson, phi, rho )
    class(poisson_2d_polar_parallel_solver), target :: poisson
...
!    end subroutine compute_E_from_phi_2d_fft
    ...
    print*, 'l2norm_squarred not implemented for poisson_2d_polar_parallel_solver.'
