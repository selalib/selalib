...
contains
  ...
  subroutine solve_poisson_2d_periodic_cartesian_par(plan, rho, phi)
    ...
    do j=1,npy_loc
       call fft_apply_plan(plan%px, plan%fft_x_array(:,j), plan%fft_x_array(:,j))
    end do
    ...
    do i=1,npx_loc
       call fft_apply_plan(plan%py, plan%fft_y_array(i,:), plan%fft_y_array(i,:)) 
    end do
    ...
    do i=1,npx_loc
       call fft_apply_plan(plan%py_inv, plan%fft_y_array(i,:), plan%fft_y_array(i,:))
    end do
    ...
    do j=1,npy_loc
       call fft_apply_plan(plan%px_inv, plan%fft_x_array(:,j), plan%fft_x_array(:,j))
    end do
