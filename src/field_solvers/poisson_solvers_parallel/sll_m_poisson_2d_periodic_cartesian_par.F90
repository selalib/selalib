...
contains
  ...
  function new_poisson_2d_periodic_plan_cartesian_par( &
    ...
    plan%px => fft_new_plan_c2c_1d( &
         ncx, &
         plan%fft_x_1d_array, &
         plan%fft_x_1d_array, &
         FFT_FORWARD)!+FFT_NORMALIZE )

    plan%px_inv => fft_new_plan_c2c_1d( &
         ncx, &
         plan%fft_x_1d_array, &
         plan%fft_x_1d_array, &
    ...
    plan%py => fft_new_plan_c2c_1d( &
         ncy, &
         plan%fft_y_1d_array, &
         plan%fft_y_1d_array, &
         FFT_FORWARD)! + FFT_NORMALIZE )

    plan%py_inv => fft_new_plan_c2c_1d( &
         ncy, &
         plan%fft_y_1d_array, &
         plan%fft_y_1d_array, &
         FFT_BACKWARD)! + FFT_NORMALIZE )
  ...
  subroutine solve_poisson_2d_periodic_cartesian_par(plan, rho, phi)
    ...
    do j=1,npy_loc
       call fft_apply_plan_c2c_1d(plan%px, plan%fft_x_array(:,j), plan%fft_x_array(:,j))
    end do
    ! FFTs in y-direction
    ...
    do i=1,npx_loc
       call fft_apply_plan_c2c_1d(plan%py, plan%fft_y_array(i,:), plan%fft_y_array(i,:)) 
    end do
    ...
    do i=1,npx_loc
       call fft_apply_plan_c2c_1d(plan%py_inv, plan%fft_y_array(i,:), plan%fft_y_array(i,:))
    end do
    ...
    do j=1,npy_loc
       call fft_apply_plan_c2c_1d(plan%px_inv, plan%fft_x_array(:,j), plan%fft_x_array(:,j))
    end do
  ...
  subroutine solve_poisson_2d_periodic_cartesian_par_alt(plan, rho, phi)
    ...
    call fft_apply_plan_c2c_2d(plan%px, plan%fft_x_array, plan%fft_x_array)
    ! FFTs in y-direction
    npx_loc = plan%seq_x2_local_sz_x1
    npy_loc = plan%seq_x2_local_sz_x2
    ...
    call fft_apply_plan_c2c_2d(plan%py, plan%fft_y_array, plan%fft_y_array) 
    ...
    ! Inverse FFTs in y-direction
    call fft_apply_plan_c2c_2d(plan%py_inv, plan%fft_y_array, plan%fft_y_array) 
    ...
    call fft_apply_plan_c2c_2d(plan%px_inv, plan%fft_x_array, plan%fft_x_array)
