...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  !-----------------------------------------------------------------------------
  type, extends(c_test_dirichlet) :: t_test_qn_solver_2d_polar_dirichlet_quadratic
  ...
  end type t_test_qn_solver_2d_polar_dirichlet_quadratic
...
!<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  ...
  pure function f_test__rho_m0( self, r ) result( val )
    class(t_test_qn_solver_2d_polar_dirichlet_quadratic), intent(in) :: self
...
end module m_test_qn_solver_2d_polar_dirichlet
