program test_qn_solver_2d_fem_sps_stencil_grid
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  ! Integer variables
  integer :: mm, n1, n2, p1, p2, ncells1, ncells2, file_er, file_unit
  ...
  ! Create HDF5 file
  call sll_s_hdf5_ser_file_create( 'test_qn_solver_2d_fem_sps_stencil_grid.h5', file_id, file_er )
...
end program test_qn_solver_2d_fem_sps_stencil_grid
