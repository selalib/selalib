...
type sll_t_maxwell_2d_periodic_plan_cartesian_par
   ...
   type(sll_t_fft)                           :: fwx         !< fft plan forward x
   type(sll_t_fft)                           :: fwy         !< fft plan forward y
   type(sll_t_fft)                           :: bwx         !< fft plan backward x
   type(sll_t_fft)                           :: bwy         !< fft plan backward y
