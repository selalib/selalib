...
!
program test_maxwell_3d_trafo_parallel
  !------------------------------------------------------------------------
...
#include "sll_maxwell_solvers_macros.h"
  ...
  type(sll_t_maxwell_3d_trafo_parallel)    :: maxwell_3d
...
!!$  call sll_s_plot_two_fields_1d('Ex3dcl',nc_total, efield_val1(1:nc_total),efield_ref(1:nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('Ey3dcl',nc_total, efield_val1(nc_total+1:2*nc_total),efield_ref(nc_total+1:2*nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('Ez3dcl',nc_total, efield_val1(2*nc_total+1:3*nc_total),efield_ref(2*nc_total+1:3*nc_total),0,0.0_f64)
...
!!$  call sll_s_plot_two_fields_1d('Bx3dcl',nc_total,bfield_val1(1:nc_total),bfield_ref(1:nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('By3dcl',nc_total,bfield_val1(nc_total+1:2*nc_total),bfield_ref(nc_total+1:2*nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('Bz3dcl',nc_total,bfield_val1(2*nc_total+1:3*nc_total),bfield_ref(2*nc_total+1:3*nc_total),0,0.0_f64)
...
!!$  call sll_s_plot_two_fields_1d('Poissonx',nc_total, efield(1:nc_total),efield_ref(1:nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('Poissony',nc_total, efield(nc_total+1:2*nc_total),efield_ref(nc_total+1:2*nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('Poissonz',nc_total, efield(2*nc_total+1:3*nc_total),efield_ref(2*nc_total+1:3*nc_total),0,0.0_f64)

  !L2 norm
  call maxwell_3d%L2projection( 1, 0, efield, cos_k, cos_k, cos_k )
  error(2) = abs(maxwell_3d%inner_product( efield, efield, 1, 1 )- 0.5_f64*sll_p_twopi**3)!0._f64*params(1)*params(2)*params(3)) 
...
!!$  call sll_s_plot_two_fields_1d('Ex3d',nc_total, efield(1:nc_total),efield_ref(1:nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('Ey3d',nc_total, efield(nc_total+1:2*nc_total),efield_ref(nc_total+1:2*nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('Ez3d',nc_total, efield(2*nc_total+1:3*nc_total),efield_ref(2*nc_total+1:3*nc_total),0,0.0_f64)
!!$
!!$  call sll_s_plot_two_fields_1d('Bx3d',nc_total, bfield(1:nc_total),bfield_ref(1:nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('By3d',nc_total, bfield(nc_total+1:2*nc_total),bfield_ref(nc_total+1:2*nc_total),0,0.0_f64)
!!$  call sll_s_plot_two_fields_1d('Bz3d',nc_total, bfield(2*nc_total+1:3*nc_total),bfield_ref(2*nc_total+1:3*nc_total),0,0.0_f64)
...
end program test_maxwell_3d_trafo_parallel
