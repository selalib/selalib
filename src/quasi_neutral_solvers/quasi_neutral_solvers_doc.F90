...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup quasi_neutral_solverss.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup quasi_neutral_solvers sll_quasi_neutral_solvers 
!> @brief 
!> Description of quasi_neutral_solvers library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  quasi_neutral_solvers, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_quasi_neutral_solvers.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_quasi_neutral_solvers.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_quasi_neutral_solvers </code>
!>
!> <b> Examples </b>
