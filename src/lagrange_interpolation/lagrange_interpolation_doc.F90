...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup lagrange_interpolations.html 
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_lagrange_interpolation.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_lagrange_interpolation </code>
!>
!> <b> Examples </b>
