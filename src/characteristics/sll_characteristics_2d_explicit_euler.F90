...
module sll_module_characteristics_2d_explicit_euler
...
contains
  function new_explicit_euler_2d_charac(&
    ...
    call initialize_explicit_euler_2d_charac(&
      charac, &
      Npts1, &
      Npts2, &
      bc_type_1, &
  ...
  end subroutine initialize_explicit_euler_2d_charac

  subroutine compute_explicit_euler_2d_charac( &
      charac, &
      A1, &
      A2, &
      dt, &
...
end module sll_module_characteristics_2d_explicit_euler
