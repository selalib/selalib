module sll_m_extraction_operator_12
...
#include "sll_assert.h"
  ...
  public :: sll_t_extraction_operator_12

  private
  type, extends(sll_t_linear_operator_abstract) :: sll_t_extraction_operator_12
     sll_int32 :: n_dofs(2)
     sll_int32 :: n0
     sll_int32 :: nk
   ...
   contains
     procedure :: create => create_extraction_operator_12
     procedure :: free => free_extraction_operator_12
     procedure :: dot => dot_extraction_operator_12
     procedure :: print_info => print_info_extraction_operator_12

  end type sll_t_extraction_operator_12


contains

  subroutine create_extraction_operator_12( self, n_dofs, conp, k, tau )
    class(sll_t_extraction_operator_12), intent( inout ) :: self
  ...
  end subroutine create_extraction_operator_12

  subroutine free_extraction_operator_12( self )
    class(sll_t_extraction_operator_12), intent( inout ) :: self

  end subroutine free_extraction_operator_12


  subroutine dot_extraction_operator_12 ( self, x, y )
    class(sll_t_extraction_operator_12), intent( in ) :: self
  ...
  end subroutine dot_extraction_operator_12


  subroutine print_info_extraction_operator_12( self )
    class(sll_t_extraction_operator_12), intent(in) :: self

  end subroutine print_info_extraction_operator_12


end module sll_m_extraction_operator_12
