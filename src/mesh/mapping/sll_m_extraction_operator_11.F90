module sll_m_extraction_operator_11
...
#include "sll_assert.h"
  ...
  public :: sll_t_extraction_operator_11

  private
  type, extends(sll_t_linear_operator_abstract) :: sll_t_extraction_operator_11
     sll_int32 :: n_dofs(2)
     sll_int32 :: n0
     sll_int32 :: nk
   ...
   contains
     procedure :: create => create_extraction_operator_11
     procedure :: free => free_extraction_operator_11
     procedure :: dot => dot_extraction_operator_11
     procedure :: print_info => print_info_extraction_operator_11

  end type sll_t_extraction_operator_11


contains

  subroutine create_extraction_operator_11( self, n_dofs, conp, k, tau )
    class(sll_t_extraction_operator_11), intent( inout ) :: self
    ...
    self%n_rows = product(self%n_dofs) - self%n_dofs(2) + self%nk
    self%n_cols = product(self%n_dofs) 

    self%n_global_rows = self%n_rows
    self%n_global_cols = self%n_cols

  end subroutine create_extraction_operator_11

  subroutine free_extraction_operator_11( self )
    class(sll_t_extraction_operator_11), intent( inout ) :: self

  end subroutine free_extraction_operator_11


  subroutine dot_extraction_operator_11 ( self, x, y )
    class(sll_t_extraction_operator_11), intent( in ) :: self
  ...
  end subroutine dot_extraction_operator_11


  subroutine print_info_extraction_operator_11( self )
    class(sll_t_extraction_operator_11), intent(in) :: self

  end subroutine print_info_extraction_operator_11


end module sll_m_extraction_operator_11
