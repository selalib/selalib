...
module sll_module_gces_periodic
...
type(sll_gces_periodic), intent(out) :: es
...
type(sll_gces_periodic), pointer :: es
...
type(sll_gces_periodic),intent(inout) :: es
...
class(sll_gces_periodic), intent(inout)      :: es
