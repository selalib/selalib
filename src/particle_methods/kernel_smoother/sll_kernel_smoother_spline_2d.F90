...
#include "sll_memory.h"
  ...
  type, extends(sll_kernel_smoother_base) :: sll_kernel_smoother_spline_2d
     ...
     sll_int32,  allocatable :: index_grid(:,:)
     sll_real64, allocatable :: values_grid(:,:,:)
   ...
   contains
     ...
     ! TODO: j functions, shape factors continue (maybe use arbitrary degree spline), initialization function
