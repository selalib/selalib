...
sll_real64, parameter             :: dt = 0.02_f64
sll_real64                        :: dx
sll_real64                        :: dy
sll_real64                        :: delta
sll_int32                         :: error
...
poisson => sll_f_new_poisson_2d_periodic_fft(xmin,xmax,nx,ymin,ymax,ny)
...
do istep = 1, nstep !loop over time
  ...
  call sll_o_pic_viewer_write( viewer, xp, yp, op, istep, time )
