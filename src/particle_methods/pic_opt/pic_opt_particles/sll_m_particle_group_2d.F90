...
#include "sll_working_precision.h"
   ...
   public :: &
      sll_s_particle_2d_group_init, &
      sll_s_particle_2d_group_free, &
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   type :: sll_t_particle_group_2d
      ...
      type(sll_t_particle_2d), dimension(:), pointer       :: p_list
      type(sll_t_particle_2d_guard_ptr), dimension(:), pointer :: p_guard
   end type sll_t_particle_group_2d

   interface sll_o_delete
      module procedure sll_s_particle_2d_group_free
   end interface sll_o_delete

contains

   subroutine sll_s_particle_2d_group_init( &
      res, &
      num_particles, &
      particle_array_size, &
      guard_list_size, &
      ...
      type(sll_t_particle_group_2d) :: res
      ...
      if (num_particles > particle_array_size) then
         print *, 'sll_f_new_particle_2d_group(): ERROR,  num_particles should not ', &
...
!$omp end parallel
   ...
   end subroutine sll_s_particle_2d_group_init

   function sll_f_new_particle_2d_group( &
      num_particles, &
      particle_array_size, &
      guard_list_size, &
      qoverm, &
      ...
      type(sll_t_particle_group_2d), pointer :: res
      sll_int32, intent(in) :: num_particles
      sll_int32, intent(in) :: particle_array_size
      sll_int32, intent(in) :: guard_list_size
      sll_real64, intent(in) :: qoverm
      ...
      call sll_s_particle_2d_group_init( &
         res, &
         num_particles, &
         particle_array_size, &
         guard_list_size, &
   ...
   end function sll_f_new_particle_2d_group

   subroutine sll_s_particle_2d_group_free(p_group)
   ...
   end subroutine sll_s_particle_2d_group_free
