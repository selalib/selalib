...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  type sll_t_marker_list_element
    sll_int32 :: cell_j_x
    sll_int32 :: cell_j_y
    sll_int32 :: cell_j_vx
    sll_int32 :: cell_j_vy
    ...
    sll_int32 :: flag
    type(sll_t_marker_list_element), pointer :: next
...
contains
  ...
  function sll_f_marker_index_from_initial_position_on_cartesian_grid (j_x, j_y, j_vx, j_vy,                                &
  ...
  end function sll_f_marker_index_from_initial_position_on_cartesian_grid


  ! <<sll_s_get_initial_position_on_cartesian_grid_from_marker_index>>

  subroutine sll_s_get_initial_position_on_cartesian_grid_from_marker_index (k,                                         &
                                                                       n_parts_x, n_parts_y, n_parts_vx, n_parts_vy,    &
                                                                       j_x, j_y, j_vx, j_vy                             &
                                                                       )
...
!    use sll_m_working_precision
  ...
  subroutine sll_s_update_closest_marker_arrays(k_part,                         &
  ...
  end subroutine sll_s_update_closest_marker_arrays
