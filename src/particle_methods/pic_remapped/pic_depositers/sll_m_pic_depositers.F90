...
contains
  ...
  subroutine charge_deposit_particle_group( &
    ...
    class(sll_t_pic_depositer),                   intent( inout )        :: self
...
end module  sll_m_pic_depositers
