...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  type, abstract :: sll_c_particle_mesh_coupling
   ...
   contains
     ...
     procedure(add_single_pp), deferred     :: add_charge_pp !> Add the contribution of one particle to the charge density
     ...
     procedure(add_update_pp) , deferred       :: add_current_update_v_pp !> Add contribution of pne particle to the current density and update velocity 
!     procedure(add_single), deferred        :: add_current_single !> Add the contribution of one particle to the charge density
     procedure(eval_single_pp), deferred    :: evaluate_pp
  ...
  !---------------------------------------------------------------------------!
  abstract interface
     subroutine add_single_pp(self, position, marker_charge, rho_dofs) 
       use sll_m_working_precision
       import sll_c_particle_mesh_coupling
       class (sll_c_particle_mesh_coupling), intent( inout ) :: self !< Kernel smoother object
       sll_real64,                    intent( in )    :: position(self%dim) !< Position of the particle
  ...
  abstract interface
     subroutine eval_single_pp(self, position, field_dofs_pp, field_value)
       use sll_m_working_precision
       import sll_c_particle_mesh_coupling
       class (sll_c_particle_mesh_coupling), intent( inout ) :: self !< Kernel smoother object 
       sll_real64,                    intent( in )    :: position(self%dim) !< Position of the particle
