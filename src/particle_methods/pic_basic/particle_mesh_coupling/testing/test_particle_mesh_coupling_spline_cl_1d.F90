...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  ! Rho dofs
  sll_real64 :: rho_dofs(13)
  sll_real64 :: rho_dofs1(13)
  sll_real64 :: rho_dofs_ref(13)
  ! J dofs
  sll_real64 :: j_dofs(12)
  sll_real64 :: j_dofs2(12)
  sll_real64 :: j_dofs_ref(12)
  ! B dofs
  sll_real64 :: b_dofs(12)
  ...
  j_dofs_ref = [ 2.4617513020833336D-002,   4.0690104166666692D-005, 0.0_f64, &
       ...
       0.11535644531249999_f64,    0.11535644531249999_f64];
  j_dofs_ref = j_dofs_ref + [ -0.16219075520833331_f64, -0.16219075520833331_f64, &
       ...
       -2.52685546875D-002, -2.52685546875D-002];
  j_dofs_ref = j_dofs_ref + [ 6.5104166666666696D-004,  0.0_f64, 0.0_f64,  &
       ...
       5.0130208333333329D-002, 5.0130208333333329D-002];
