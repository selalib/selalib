program test_particle_mesh_coupling_spline_3d_feec
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  type(sll_t_particle_mesh_coupling_spline_3d_feec) :: particle_mesh
  type(sll_t_particle_group_3d3v) :: particle_group
  type(sll_t_maxwell_3d_fem_fft) :: maxwell
  ...
  sll_real64 :: j_dofs_ref(n_grid**3*3)
  ! B dofs
 ...
 passed = .TRUE.
  ...
  call maxwell%init( domain, n_cells, [spline_degree,spline_degree,spline_degree] )
