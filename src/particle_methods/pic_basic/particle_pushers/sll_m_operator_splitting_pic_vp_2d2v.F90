...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  type, extends(sll_t_operator_splitting) :: sll_t_operator_splitting_pic_vp_2d2v
     class(sll_t_poisson_2d_fft_solver), pointer    :: poisson_solver      !< Poisson solver (TODO: Use a base class here)
...
contains
  ...
  subroutine initialize_operator_splitting_pic_vp_2d2v(this, poisson_solver, kernel_smoother, particle_group)
    ...
    class(sll_t_poisson_2d_fft_solver),pointer, intent(in) :: poisson_solver !< poisson solver
