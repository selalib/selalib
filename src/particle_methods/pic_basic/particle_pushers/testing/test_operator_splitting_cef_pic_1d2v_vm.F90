...
program test_operator_splitting_cef_pic_1d2v_vm
...
#include "sll_constants.h"
  ...
  class(sll_operator_splitting_cef_pic_1d2v_vm), pointer :: propagator
  ...
  propagator => sll_new_splitting_cef_pic_1d2v_vm(maxwell_solver, &
...
end program test_operator_splitting_cef_pic_1d2v_vm
