...
#include "sll_working_precision.h"
  ...
  type, extends(sll_c_pic_poisson) :: sll_t_pic_poisson_2d
     ...
     class(sll_c_particle_mesh_coupling_1d), pointer :: kernel     !< Kernel smoother taking care of charge deposition and field evaluation
...
contains
  ...
  subroutine init_pic_poisson_2d(self, no_gridpts, poisson, kernel)
    ...
    class( sll_c_particle_mesh_coupling_1d), pointer, intent(in)  :: kernel !< kernel smoother object
