...
contains
    ...
    procedure :: print => print_particle_group_1d1v !> print out particle array
...
!----------------------------------------------------------------------!
  ...
  subroutine delete_particle_group_1d1v(self)
    class( sll_t_particle_group_1d1v ), intent(inout) :: self
...
!----------------------------------------------------------------------!
 ...
 !----------------------------------------------------------------------!
  ...
  subroutine print_particle_group_1d1v(self, filename)
    class( sll_t_particle_group_1d1v ), intent(in) :: self
