module sll_m_linear_operator_particle_mass_3d_od
#include "sll_working_precision.h"
  ...
  public :: sll_t_linear_operator_particle_mass_3d_od
  
  private

  type, extends(sll_c_particle_mass_3d_base) :: sll_t_linear_operator_particle_mass_3d_od
     sll_int32 :: degree2(3) !< spline degree2
     
   contains
     procedure :: create => create_linear_operator_particle_mass_3d_od
     procedure :: free => free_particle_mass_3d_od
     procedure :: dot => dot_particle_mass_3d_od
     procedure :: print_info => print_info_particle_mass_3d_od

  end type sll_t_linear_operator_particle_mass_3d_od


contains

  subroutine create_linear_operator_particle_mass_3d_od( self, n_cells, degree, degree2 )
    class(sll_t_linear_operator_particle_mass_3d_od), intent( inout ) :: self !< Particle mass
  ...
  end subroutine create_linear_operator_particle_mass_3d_od
  ...
  end subroutine free_particle_mass_3d_od
  
  
  subroutine dot_particle_mass_3d_od ( self, x, y )
    class(sll_t_linear_operator_particle_mass_3d_od), intent( in ) :: self !< Particle mass
          ...
          do i1 = 1, self%n_dofs(1)
             ...
             do j3 = i3-self%degree2(3), i3+self%degree(3)
                do j2 = i2-self%degree2(2), i2+self%degree(2)
                   do j1 = i1-self%degree2(1), i1+self%degree(1)
  ...
  end subroutine dot_particle_mass_3d_od
  ...
  subroutine print_info_particle_mass_3d_od( self )
    class(sll_t_linear_operator_particle_mass_3d_od), intent(in) :: self !< Particle mass 
  end subroutine print_info_particle_mass_3d_od
  
end module sll_m_linear_operator_particle_mass_3d_od
