...
program test_time_propagator_pic_1d2v_vm_subcyci
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  type(sll_t_time_propagator_pic_vm_1d2v_subcyci) :: propagator
...
!5.7026946767517002_f64    ], [n_particles, 4]) ! Reference for Picard
  particle_info_ref = reshape([   11.63881566587555_f64,        &
       5.504453448823855_f64,        -1.374476100378738_f64,       &
       3.720899151808577E-002_f64,    -0.3208171521225062_f64,       &
      -1.399491257683329_f64,         6.86367593760747_f64,        &
       5.70269467675170_f64    ], [n_particles, 4]) ! Reference for Newton
  ...
  bfield_ref = [  0.9641024805894207d0,        1.063726533513822d0, &
       0.8894898764587650d0,        1.050611920219342d0, &
       1.036712174418004d0,       0.9678882301912780d0, &
       1.030065327009114d0,       0.9619492343036471d0, &
       1.016091397442023d0,        1.019362825854586d0 & 
  ]
  
  efield_ref = reshape([0.306341738388944d0,       0.2250411896590129d0, &
       -3.299173355327213d0,        1.005125384044904d0, &
       2.382136154545293d0,      -0.5284521142287050d0, &
       -7.308129083234483d-002,  -4.443482362545564d0, &
       2.634308003151899d0,        2.537436356833017d0, &
       1.286286727354976d0,       0.4854754892519077d0, &
       1.874186658309685d0,       1.238178511329060d0, &
       0.7768397215334321d0,        1.180368122032822d0, &
       0.8025560801943996d0,        1.280716104094914d0, &
       1.078505640135508d0,       0.8351851943054848d0 &
...
end program test_time_propagator_pic_1d2v_vm_subcyci
