...
module sll_m_time_propagator_pic_vm_1d2v_disgradEC_trafo
  !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#include "sll_working_precision.h"
  ...
  type, extends(sll_c_time_propagator_base) :: sll_t_time_propagator_pic_vm_1d2v_disgradEC_trafo
  ...
  end type sll_t_time_propagator_pic_vm_1d2v_disgradEC_trafo
...
contains
  ...
  subroutine strang_splitting_pic_vm_1d2v(self,dt, number_steps)
    class(sll_t_time_propagator_pic_vm_1d2v_disgradEC_trafo), intent(inout) :: self !< time propagator object 
...
end module sll_m_time_propagator_pic_vm_1d2v_disgradEC_trafo
