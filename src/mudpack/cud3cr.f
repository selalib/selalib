...
c
c
c ... purpose (see cud3cr.d for details)
c
...
c
c     see the documentation file "cud3cr.d" for a complete discussion
c     of how to use subroutine cud3cr.  file "tcud3cr.f" is a test/driver
c     sample program illustrating use of cud3cr
c
