...
c
c
c ... purpose (see mud3cr.d for details)
c
...
c
c     see the documentation file "mud3cr.d" for a complete discussion
c     of how to use subroutine mud3cr.  file "tmud3cr.f" is a test/driver
c     sample program illustrating use of mud3cr
c
