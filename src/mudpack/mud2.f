...
c
c ... purpose (see mud2.d for details)
c
...
c
c     see the documentation file "mud2.d" for a complete discussion
c     of how to use subroutine mud2.  file "tmud2.f" is a test/driver
c     sample program illustrating use of mud2
c
