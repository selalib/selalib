...
c
c ... purpose (see cuh2cr.d for details)
c
...
c
c     see the documentation file "cuh2cr.d" for a complete discussion
c     of how to use subroutine cuh2cr.  file "tcuh2cr.f" is a test/driver
c     sample program illustrating use of cuh2cr
c
