...
c
c     see the documentation file "mud34.d" for a complete discussion
c     of how to use subroutine mud34.  file "tmud34.f" is a test/driver
c     sample program illustrating use of mud34
c
c ... purpose (see mud34.d for details)
c
