...
c ... purpose
c
c     cudcom.f is a common subroutines file containing subroutines
c     called by some or all of the COMPLEX two- and three-dimensional
c     mudpack solvers.  cudcom.f must be loaded with any complex mudpack
c     solver.
c
