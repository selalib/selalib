...
c
c ... purpose (see cud2sp.d for details)
c
...
c
c     see the documentation file "cud2sp.d" for a complete discussion
c     of how to use subroutine cud2sp.  file "tcud2sp.f" is a test/driver
c     sample program illustrating use of cud2sp
c
