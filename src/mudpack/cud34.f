...
c
c     see the documentation file "cud34.d" for a complete discussion
c     of how to use subroutine cud34.  file "tcud34.f" is a test/driver
c     sample program illustrating use of cud34
c
c ... purpose (see cud34.d for details)
c
