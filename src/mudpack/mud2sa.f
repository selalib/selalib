...
c
c ... purpose (see mud2sa.d for details)
c
...
c
c     see the documentation file "mud2sa.d" for a complete discussion
c     of how to use subroutine mud2sa.  file "tmud2sa.f" is a test/driver
c     sample program illustrating use of mud2sa
c
