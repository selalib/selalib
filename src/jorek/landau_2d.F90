...
!Elliptic solver
sll_int32, parameter :: k_eta1 = 3
sll_int32, parameter :: k_eta2 = 3
...
type(sll_arbitrary_degree_spline_interpolator_2d), target :: interp_smb
...
class(sll_scalar_field_2d_base), pointer                  :: smb
...
mesh_2d => new_cartesian_mesh_2d( nc_eta1, &
                                  nc_eta2, &
                                  eta1_min,    &
                                  eta1_max,    &
                                  eta2_min,    &
...
call initialize_ad2d_interpolator( interp_phi,   &
&                                  nc_eta1+1,    &
&                                  nc_eta2+1,    &
&                                  eta1_min,     &
&                                  eta1_max,     &
...
call initialize_ad2d_interpolator( interp_smb,   &
&                                  nc_eta1+1,    &
&                                  nc_eta2+1,    &
&                                  eta1_min,     &
&                                  eta1_max,     &
...
phi => new_scalar_field_2d_discrete( "phi",        &
&                                    interp_phi,   &
&                                    tau,          &
&                                    SLL_PERIODIC, &
&                                    SLL_PERIODIC, &
...
smb => new_scalar_field_2d_analytic( rhs,          &
&                                    "smb",        &     
&                                    tau,          &
&                                    SLL_PERIODIC, &
&                                    SLL_PERIODIC, &
