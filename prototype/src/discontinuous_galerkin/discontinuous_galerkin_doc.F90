...
!>  - sll_discontinuous_galerkin.h
!>
!> <b> Modules available </b>
!>  List fortran module available
!>  - sll_discontinuous_galerkin
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_discontinuous_galerkin.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_discontinuous_galerkin </code>
!>
!> <b> Examples </b>
