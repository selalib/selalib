...
SLL_CLEAR_ALLOCATE(bx(nc_eta1+1,nc_eta2+1), error)
SLL_CLEAR_ALLOCATE(by(nc_eta1+1,nc_eta2+1), error)
SLL_CLEAR_ALLOCATE(ez(nc_eta1+1,nc_eta2+1), error)
SLL_CLEAR_ALLOCATE(ez_exact(nc_eta1+1,nc_eta2+1), error)
