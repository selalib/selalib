...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup distribution_function_multipatchs.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup distribution_function_multipatch sll_distribution_function_multipatch 
!> @brief 
!> Description of distribution_function_multipatch library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  distribution_function_multipatch, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_distribution_function_multipatch.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_distribution_function_multipatch.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_distribution_function_multipatch </code>
!>
!> <b> Examples </b>
