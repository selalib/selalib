...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup random_deviate_generatorss.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup random_deviate_generators sll_random_deviate_generators 
!> @brief 
!> Description of random_deviate_generators library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  random_deviate_generators, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_random_deviate_generators.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_random_deviate_generators.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_random_deviate_generators </code>
!>
!> <b> Examples </b>
