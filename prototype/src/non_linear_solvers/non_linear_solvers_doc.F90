...
!> @namespace sll_non_linear_solvers 
!> @brief 
!> Description of non_linear_solvers library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.!> @details
!> Long description of  non_linear_solvers, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_non_linear_solvers.h
!>
!> <b> Modules available </b>
!>  List fortran module available
!>  - sll_non_linear_solvers
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_non_linear_solvers.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_non_linear_solvers </code>
!>
!> <b> Examples </b>
