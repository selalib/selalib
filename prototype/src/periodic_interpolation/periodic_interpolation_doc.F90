...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup periodic_interpolations.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup periodic_interpolation sll_periodic_interpolation 
!> @brief 
!> Description of periodic_interpolation library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  periodic_interpolation, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_periodic_interpolation.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_periodic_interpolation.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_periodic_interpolation </code>
!>
!> <b> Examples </b>
