...
!             '. DIFFERENCE  = ', delta2
  ...
  inquire(file="../src/coordinate_transformations/n63x63p3x3_patch0.nml", exist=l_exists)

  if (l_exists) then
     call t_n%read_from_file("../src/coordinate_transformations/n63x63p3x3_patch0.nml")
