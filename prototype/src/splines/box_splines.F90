...
MAKE_GET_SLOT_FUNCTION(get_r3_x2_lbs2d, linear_box_spline_2d, r3_x2, sll_real64 )
  ...
  function new_linear_box_spline_2D( &
    ...
    new_linear_box_spline_2D%rdelta  = 1.0_f64/new_linear_box_spline_2D%delta
    ...
    SLL_ALLOCATE( new_linear_box_spline_2D%coeffs(0:num_pts_x1+2,0:num_pts+2), ierr )
  ...
  subroutine compute_linear_box_spline_2D( data, spline )
    ...
    type(sll_linear_box_spline_2D), pointer        :: spline
    sll_int32 :: bc1
    sll_int32 :: bc2
    sll_int32 :: bc_selector
