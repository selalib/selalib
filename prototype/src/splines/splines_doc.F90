...
!> @brief 
!> Description of splines library (72 characters)
!> @details
!> Long description of  splines, you can add some references or math equations.
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_splines.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_splines </code>
!>
!> <b> Examples </b>
