...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup parallel_array_initializerss.html 
...
!> @details
!> Long description of  parallel_array_initializers, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_parallel_array_initializers.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_parallel_array_initializers.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_parallel_array_initializers </code>
!>
!> <b> Examples </b>
