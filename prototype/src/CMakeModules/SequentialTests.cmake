...
IF(MUDPACK_ENABLED AND Fortran_COMPILER STREQUAL "GFORTRAN")
   ...
   ELSE()
      ADD_TEST(NAME mudpack_2d COMMAND tmud2 tmud24 )
      SET(mudpack_2d PROPERTIES PASS_REGULAR_EXPRESSION "PASSED")
      ADD_TEST(NAME mudpack_2d_sp COMMAND tmud2sp tmud24sp )
      SET(mudpack_2d_sp PROPERTIES PASS_REGULAR_EXPRESSION "PASSED")
   ENDIF()
ENDIF()
