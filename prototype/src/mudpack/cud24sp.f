...
c
c ... purpose (see cud24sp.d for details)
c
...
c
c     see the documentation file "cud24sp.d" for a complete discussion
c     of how to use subroutine cud24sp.  file "tcud24sp.f" is a test/driver
c     sample program illustrating use of cud24sp
c
