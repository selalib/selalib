...
c
c ... purpose (see cud24cr.d for details)
c
...
c
c     see the documentation file "cud24cr.d" for a complete discussion
c     of how to use subroutine cud24cr.  file "tcud24cr.f" is a test/driver
c     sample program illustrating use of cud24cr
c
