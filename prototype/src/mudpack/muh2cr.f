...
c
c ... purpose (see muh2cr.d for details)
c
...
c
c     see the documentation file "muh2cr.d" for a complete discussion
c     of how to use subroutine muh2cr.  file "tmuh2cr.f" is a test/driver
c     sample program illustrating use of muh2cr
c
