...
c
c ... purpose (see cud2.d for details)
c
...
c
c     see the documentation file "cud2.d" for a complete discussion
c     of how to use subroutine cud2.  file "tcud2.f" is a test/driver
c     sample program illustrating use of cud2
c
