...
c
c ... purpose (see cuh24.d for details)
c
...
c
c     see the documentation file "cuh24.d" for a complete discussion
c     of how to use subroutine cuh24.  file "tcuh24.f" is a test/driver
c     sample program illustrating use of cuh2
c
