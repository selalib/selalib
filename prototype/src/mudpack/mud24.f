...
c
c ... purpose (see mud24.d for details)
c
...
c
c     see the documentation file "mud24.d" for a complete discussion
c     of how to use subroutine mud24.  file "tmud24.f" is a test/driver
c     sample program illustrating use of mud24
c
