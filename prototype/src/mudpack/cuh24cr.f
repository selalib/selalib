...
c
c ... purpose (see cuh24cr.d for details)
c
...
c
c     see the documentation file "cuh24cr.d" for a complete discussion
c     of how to use subroutine cuh24cr.  file "tcuh24cr.f" is a test/driver
c     sample program illustrating use of cuh24cr
c
