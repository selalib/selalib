...
c
c     see the documentation file "muh34.d" for a complete discussion
c     of how to use subroutine muh34.  file "tmuh34.f" is a test/driver
c     sample program illustrating use of muh34
c
c ... purpose (see muh34.d for details)
c
