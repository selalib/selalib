...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup pic_methodss.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup pic_methods sll_pic_methods 
!> @brief 
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_pic_methods.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_pic_methods </code>
!>
!> <b> Examples </b>
