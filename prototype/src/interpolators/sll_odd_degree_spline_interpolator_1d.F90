...
#ifdef STDF95
  type                                    :: odd_degree_spline_1d_interpolator
#else  
  type, extends(sll_interpolator_1d_base) :: odd_degree_spline_1d_interpolator
#endif
...
contains  ! ****************************************************************
...
#ifdef STDF95
  function odd_degree_spline_interpolate_array(this, num_points, data, coordinates) &
       result(data_out)
    type(odd_degree_spline_1d_interpolator),  intent(in)       :: this
#else
  function spline_interpolate1d(this, num_points, data, coordinates) &
       result(data_out)
    class(odd_degree_spline_1d_interpolator),  intent(in)       :: this
#endif
...
#ifdef STDF95
  function odd_degree_spline_interpolate_array_at_displacement(this, num_points, &
       data, coordinates) &
       result(data_out)
    type(odd_degree_spline_1d_interpolator),  intent(in)       :: this
#else
  function spline_interpolate1d_disp(this, num_points, data, alpha) &
    ...
    data_out = odd_degree_splines_interpolator_uniform_array( coordinates, &
  ...
  function interpolate_value_qs1d( interpolator, eta1 ) result(val)
    ...
    val = odd_degree_splines_interpolator_uniform_value( eta1, interpolator%spline )
...
#ifdef STDF95
  subroutine odd_degree_spline_initialize( &
#else
...
!    sll_int32,  intent(in)           :: bc_type
    ...
    interpolator%spline => new_odd_degree_splines_uniform(num_points, deg, xmin, xmax)
  end subroutine
...
#ifdef STDF95
    type(odd_degree_spline_1d_interpolator) :: obj
#else
    class(odd_degree_spline_1d_interpolator) :: obj
#endif
