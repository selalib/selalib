real(8) function bvalue2d ( ar_x, ar_y, ai_nx, ai_kx, ai_ny, ai_ky, apr_Bcoef, apr_tx, apr_ty )
	implicit none
		! INPUT
		real(8) :: ar_x, ar_y
                real(8) :: bvalue
		...
		do li_j = 1, ai_ky
			...
			lpr_coef ( li_j ) = bvalue ( apr_tx, apr_bcoef ( 1 , li_lefty - ai_ky + li_j ), ai_nx, ai_kx, ar_x, 0 )

		end do	
		
		bvalue2d = bvalue ( apr_ty ( li_lefty - ai_ky + 1 ), lpr_coef, ai_ky, ai_ky, ar_y, 0 )
