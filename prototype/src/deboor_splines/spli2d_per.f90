subroutine spli2d_perdir ( ar_L, ai_nx, ai_kx, apr_taux, ai_ny, ai_ky, apr_tauy, apr_g, apr_Bcoef, apr_tx, apr_ty )
	...
	implicit none
        ...
        !print*, 'rer1'
		call spli2d_custom ( ai_nx, ai_kx, lpr_taux, ai_ny, ai_ky, apr_tauy, lpr_g, apr_Bcoef, apr_tx, apr_ty )
			
	end subroutine spli2d_perdir

subroutine spli2d_dirper (ai_nx, ai_kx, apr_taux,ar_L, ai_ny, ai_ky, apr_tauy, apr_g, apr_Bcoef, apr_tx, apr_ty )
...
!print*, 'rer1'
call spli2d_custom ( ai_nx, ai_kx, apr_taux, ai_ny, ai_ky, lpr_tauy, lpr_g, apr_Bcoef, apr_tx, apr_ty )
