...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup reductions.html 
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_reduction.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_reduction </code>
!>
!> <b> Examples </b>
