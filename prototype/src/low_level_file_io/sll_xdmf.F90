...
!> is stored using HDF5 or Binary files. 
!>
...
sll_int32, intent(out)                 :: error
sll_int32, intent(in)                  :: xmffile_id
sll_int32                              :: file_id
...
call sll_xml_field(xmffile_id,array_name,prefix//"-"//array_name//".h5:/"//array_name, &
                   npoints_x1,npoints_x2,'HDF',center)
#endif

end subroutine sll_write_data_2d

subroutine sll_write_data_3d(prefix,xmffile_id,array,array_name,center,error)
...
call sll_hdf5_file_close(file_id, error)
call sll_xml_field(xmffile_id,array_name,prefix//"-"//array_name//".h5:/"//array_name, &
                   npoints_x1,npoints_x2,npoints_x3,'HDF',center)
#endif

end subroutine sll_write_data_3d
