...
!> @namespace sll_weno 
!> @brief 
!> Description of weno library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  weno, you can add some references or math equations.
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_weno.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_weno </code>
!>
!> <b> Examples </b>
