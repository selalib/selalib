...
contains  ! ****************************************************************
  ...
  function new_WENO_1D(num_points, xmin, xmax, order, i_weno)
    ...
    new_WENO_1D%delta    = (xmax - xmin)/real(num_points,f64)
    new_WENO_1D%rdelta   = 1.0_f64/new_WENO_1D%delta
    new_WENO_1D%order = order
    new_WENO_1D%i_weno = i_weno
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine interpolate_WENO_1D(fWENO, num_points, data, coordinate_o, f_out)
    type(sll_WENO_1D), pointer         :: fWENO   ! pointer with basic discretization parameter set up and data
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine delete_WENO_1D( fWENO )
    type(sll_WENO_1D), pointer :: fWENO
    sll_int32                    :: ierr
