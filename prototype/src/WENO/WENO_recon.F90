! odd order of WENO reconstruction
...
contains  ! ****************************************************************
  ...
  function new_WENO_recon_1D(num_points, xmin, xmax, order, i_weno)
    ...
    if( xmin .gt. xmax ) then
       print *, 'ERROR, new_WENO_recon_1D: xmin is greater than xmax, this would cause all sorts of errors.'
       STOP
    end if
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine FD_WENO_recon_1D(fWENO, num_points, data, deri)
    type(WENO_recon_1D), pointer             :: fWENO   ! pointer with basic discretization parameter set up and data
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine delete_WENO_recon_1D( fWENO )
    type(WENO_recon_1D), pointer :: fWENO
    sll_int32                    :: ierr
