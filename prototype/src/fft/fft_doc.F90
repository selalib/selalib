...
!> @namespace sll_fft 
!> @brief 
!> Description of fft library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.!> @details
!> Long description of  fft, you can add some references or math equations.
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_fft.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_fft </code>
!>
!> <b> Examples </b>
