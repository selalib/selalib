...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup python_scriptss.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup python_scripts sll_python_scripts 
!> @brief 
!> Description of python_scripts library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  python_scripts, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_python_scripts.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_python_scripts.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_python_scripts </code>
!>
!> <b> Examples </b>
