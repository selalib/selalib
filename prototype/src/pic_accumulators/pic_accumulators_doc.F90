...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup pic_accumulatorss.html 
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_pic_accumulators.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_pic_accumulators </code>
!>
!> <b> Examples </b>
