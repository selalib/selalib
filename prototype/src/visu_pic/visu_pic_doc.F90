...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup visu_pics.html 
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_visu_pic.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_visu_pic </code>
!>
!> <b> Examples </b>
