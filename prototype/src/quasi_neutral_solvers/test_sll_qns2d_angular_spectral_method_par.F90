...
contains
  ...
  subroutine test_process(BC, NP_r, NP_theta, rmin, rmax, Te_seq, Zi, prod4test)
    ...
    plan => new_qns2d_angular_spect_method_par(BC,rmin,rmax,NP_r, NP_theta)
    ...
    call solve_qns2d_angular_spect_method_par(plan, rho_par, c_par, Te_par, f, g, Zi, phi)
    ...
    call delete_qns2d_angular_spect_method_par(plan)
...
end program test_sll_qns2d_angular_spect_method_par
