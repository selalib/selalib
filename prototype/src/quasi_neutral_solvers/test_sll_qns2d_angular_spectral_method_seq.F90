...
!
! Selalib 2012     
! Module: test_sll_qns2d_angular_spectral_method_seq.F90
!
!> @brief 
...
contains
  ...
  subroutine test_process(BC, NP_r, NP_theta, rmin, rmax, Te, Zi)
    ...
    plan => new_qns2d_angular_spect_method_seq(BC, rmin, rmax, NP_r, NP_theta)
    ...
    do i_test=1,2
       ...
       call solve_qns2d_angular_spect_method_seq(plan, rho, c, Te, f, g, Zi, phi)
    ...
    call delete_qns2d_angular_spect_method_seq(plan)
...
end program test_sll_qns2d_angular_spect_method_seq
