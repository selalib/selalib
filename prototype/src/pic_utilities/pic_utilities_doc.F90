...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup pic_utilitiess.html 
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_pic_utilities.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_pic_utilities </code>
!>
!> <b> Examples </b>
