...
!> @brief 
!> Description of file_io_parallel library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  file_io_parallel, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_file_io_parallel.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_file_io_parallel.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_file_io_parallel </code>
!>
!> <b> Examples </b>
