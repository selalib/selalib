...
!
  ...
  do j = 1, n
    seed = skip + j - 1
    call i8_sobol ( int(m,8), seed, r(1:m,j) )
  end do
...
!
!    Input, integer ( kind = 8 ) N, the number of (successive) points.
!
!    Input, integer ( kind = 8 ) SKIP, the number of skipped points.
!
...
!
  ...
  integer ( kind = 4 ) dim_num
  integer ( kind = 4 ), save, dimension ( dim_max ) :: tau = (/ &
     0,  0,  1,  3,  5, &
     8, 11, 15, 19, 23, &
    27, 31, 35 /)
