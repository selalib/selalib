...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup general_coordinate_elliptic_solverss.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup general_coordinate_elliptic_solvers sll_general_coordinate_elliptic_solvers 
!> @brief 
!> Description of general_coordinate_elliptic_solvers library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  general_coordinate_elliptic_solvers, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_general_coordinate_elliptic_solvers.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_general_coordinate_elliptic_solvers.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_general_coordinate_elliptic_solvers </code>
!>
!> <b> Examples </b>
