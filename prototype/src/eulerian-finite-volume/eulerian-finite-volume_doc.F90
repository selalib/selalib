...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup eulerian-finite-volumes.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup eulerian-finite-volume{eulerian-finite-volume} 
!> @brief 
!> New numerical method to solve Vlasov using finite volumes.
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  eulerian-finite-volume, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_eulerian-finite-volume.h
!>
!> <b> Modules available </b>
!>  List fortran module available
!>  - sll_eulerian-finite-volume
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_eulerian-finite-volume.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_eulerian-finite-volume </code>
!>
!> <b> Examples </b>
