...
#include "sll_misc_utils.h"
  ...
  type, extends(sll_simulation_base_class) :: &
     ...
     ! x3 averages: charge density and potential
     sll_real64, dimension(:,:), allocatable     :: phi_av_x1x2
     sll_real64, dimension(:,:), allocatable     :: rho_av_x1x2
...
contains
  ...
  subroutine run_dk_cart(sim)
    ...
    sim%mesh4d => new_cartesian_4d_mesh( sim%nc_v3, sim%nc_x1, sim%nc_x2, &
         sim%nc_x3, &
         -vmax, vmax, &
         xmin, xmax, &
         ymin, ymax, &
