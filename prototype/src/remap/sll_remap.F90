...
!    call flush(6)
  ...
  subroutine apply_remap_5D_double( plan, data_in, data_out )
    ...
    sll_int32                                 :: i
    sll_int32                                 :: col_sz
    sll_int32                                 :: loi, loj, lok, lol, lom
    sll_int32                                 :: hii, hij, hik, hil, him
    type(box_5D)                              :: sbox
    sll_int32                                 :: my_rank
    sll_int32                                 :: loc
    sll_int32, dimension(1:5)                 :: local_lo, local_hi
    sll_int32, dimension(1:5)                 :: tmpa
...
#define MAKE_GET_BOX_SLOT_FUNCTION( fname, boxtype, slot )   \
  ...
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_i_min, box_5D, i_min )
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_i_max, box_5D, i_max )
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_j_min, box_5D, j_min )
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_j_max, box_5D, j_max )
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_k_min, box_5D, k_min )
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_k_max, box_5D, k_max )
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_l_min, box_5D, l_min )
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_l_max, box_5D, l_max )
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_m_min, box_5D, m_min )
  MAKE_GET_BOX_SLOT_FUNCTION( get_box_5D_m_max, box_5D, m_max )
  ...
  function count_elements_in_box_5D( box )
    sll_int32                 :: count_elements_in_box_5D
