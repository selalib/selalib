...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup fishpacks.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup fishpack sll_fishpack 
!> @brief 
!> Description of fishpack library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  fishpack, you can add some references or math equations.
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_fishpack.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_fishpack </code>
!>
!> <b> Examples </b>
