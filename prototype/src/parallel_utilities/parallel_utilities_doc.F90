...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup parallel_utilitiess.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup parallel_utilities sll_parallel_utilities 
!> @brief 
!> Description of parallel_utilities library (72 characters)
!> @author Selalib team 
