...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup time_solverss.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup time_solvers sll_time_solvers 
!> @brief 
!> Description of time_solvers library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  time_solvers, you can add some references or math equations.
!>
...
!> - Add <code> use sll_time_solvers </code>
!>
!> <b> Examples </b>
