...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup field_accumulatorss.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup field_accumulators sll_field_accumulators 
!> @brief 
!> Description of field_accumulators library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  field_accumulators, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_field_accumulators.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_field_accumulators.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_field_accumulators </code>
!>
!> <b> Examples </b>
