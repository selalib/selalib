...
! selalib/prototype/documentation/build/html/doxygen/html/defgroup advection_fields.html 
! The following lines will be read by doxygen to generate documentation:


!> @defgroup advection_field sll_advection_field 
!> @brief 
!> Description of advection_field library (72 characters)
!> @author Selalib team 
!> You can add a contact, do not put your email to prevent spam.
!> @details
!> Long description of  advection_field, you can add some references or math equations.
!>
!> <b> Headers file available </b>
!>  - sll_advection_field.h
!>
...
!>
!> <b> How to use it </b>
!> - Header file : \code #include 'sll_advection_field.h' \endcode
!> - Link with   <code>-lsll_%s</code>
!> - Add <code> use sll_advection_field </code>
!>
!> <b> Examples </b>
