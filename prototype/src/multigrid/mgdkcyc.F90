...
subroutine mgdkcyc_3d(work,res,kcur,kcycle,iprer,ipost,iresw, &
...
call mgdrelax(sxf,exf,syf,eyf,szf,ezf,work(ipf),work(icf),iprer, &
              comm3dp,neighbor,bd,phibc(1,klevel),kdatatype(1,klevel))
...
call mgdrestr(sxc,exc,syc,eyc,szc,ezc,nxc,nyc,nzc,work(ipc),  &
              ...
              comm3dc,neighbor,bd,kdatatype(1,klevel))
...
!      
  ...
  call mgdcor(sxf,exf,syf,eyf,szf,ezf,nxf,nyf,nzf,work(ipf),     &
              ...
              sx1,ex1,sy1,ey1,sz1,ez1,bd,phibc(1,klevel+1))
!
...
!
    ...
    call mgdcor(sxf,exf,syf,eyf,szf,ezf,nxf,nyf,nzf,work(ipf),  &
                sxc,exc,syc,eyc,szc,ezc,nxc,nyc,nzc,work(ipc),  &
                sx1,ex1,sy1,ey1,sz1,ez1,bd,phibc(1,2))
!
...
call mgdrelax(sxf,exf,syf,eyf,szf,ezf,work(ipf),work(icf),ipost, &
              comm3dp,neighbor,bd,phibc(1,kcur),kdatatype(1,kcur))
...
subroutine mgdkcyc_2d(work,res,kcur,kcycle,iprer,ipost,iresw, &
