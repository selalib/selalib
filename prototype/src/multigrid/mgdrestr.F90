...
subroutine mgdrestr_3d(sxc,exc,syc,eyc,szc,ezc,nxc,nyc,nzc,phic,    &
                    rhsc,sxf,exf,syf,eyf,szf,ezf,nxf,nyf,nzf,    &
                    phif,cof,resf,iresw,comm3dp,comm3dl,comm3dc, &
                    neighbor,bd,datatypes)
...
subroutine mgdrestr_2d(sxc,exc,syc,eyc,nxc,nyc,phic,rhsc,   &
...
integer sxf,exf,syf,eyf,nxf,nyf
