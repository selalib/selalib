...
#include "sll_memory.h"
  ...
  x1_coarse => get_sll_df_x1 ( dist_func_coarse )
  x2_coarse => get_sll_df_x2 ( dist_func_coarse )
  x1_fine => get_sll_df_x1 ( dist_func_fine )
  x2_fine => get_sll_df_x2 ( dist_func_fine )
