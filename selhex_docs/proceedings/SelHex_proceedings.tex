...
%%      the top matter
%%-----------------------------
\title{A semi-Lagrangian solver for the guiding center model on a regular hexagon mesh}%\thanks{...}\thanks{...}% At most 5 thanks
%

\author{Michel Mehrenberger} \address{...} %TODO
\author{Laura S. Mendoza} \address{Max-Planck-Institut f\"{u}r Plasmaphysik; \email{mela@ipp.mpg.de\ \&\ sonnen@ipp.mpg.de}} 
