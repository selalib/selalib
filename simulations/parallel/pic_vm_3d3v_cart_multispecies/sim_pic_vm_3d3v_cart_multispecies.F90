program sim_pic_vm_3d3v_cart_multispecies
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  use sll_m_sim_pic_vm_3d3v_cart_multispecies, only: &
    sll_t_sim_pic_vm_3d3v_cart_multispecies

  implicit none
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  
  type(sll_t_sim_pic_vm_3d3v_cart_multispecies)  :: sim
...
end program sim_pic_vm_3d3v_cart_multispecies
