...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  type(sll_t_simulation_4d_dk_hybrid)  :: simulation
  ...
  cartesian_mesh4d => sll_f_new_cartesian_mesh_4d( &
  ...
  cartesian_mesh2d => sll_f_new_cartesian_mesh_2d( &
    simulation%nc_x1,simulation%nc_x2)

  !*** coordinate transformation associated with space coordinates ***
  transf_xy => sll_f_new_coordinate_transformation_2d_analytic( &
  ...
  !*** sll_o_initialize 4D drift-kinetic Vlasov ***
  call sll_o_initialize(simulation, &
    world_size, &
    my_rank, &
    cartesian_mesh4d, &
    transf_xy)
  ...
  if (simulation%my_rank.eq.0) &
    print*,': ---> First step'
  call sll_s_first_step_4d_dk_hybrid(simulation)
