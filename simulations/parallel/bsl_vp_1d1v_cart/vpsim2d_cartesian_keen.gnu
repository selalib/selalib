...
p 'thdiag.dat' u 1:($10) w l lw 3 title 'mode 1',\
  ...
  '../vpsim2d_cartesian_keen_ref.dat' u 1:($10) w l lw 2 title 'mode 1 ref',\
  '../vpsim2d_cartesian_keen_ref.dat' u 1:($11) w l lw 2 title 'mode 2 ref',\
  '../vpsim2d_cartesian_keen_ref.dat' u 1:($12) w l lw 2 title 'mode 3 ref',\
  '../vpsim2d_cartesian_keen_ref.dat' u 1:($13) w l lw 2 title 'mode 4 ref',\
  '../vpsim2d_cartesian_keen_ref.dat' u 1:($14) w l lw 2 title 'mode 5 ref'
